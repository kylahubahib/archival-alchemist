...
export default function FileUpload({ iconSize = 30, type = 'file', accept, fileFormat, className = '', onChange, ...props }) {
    return (
        <div className={`flex items-center justify-center w-full ${className}`}>
            <label
                ...
                <input id="dropzone-file" type={type} fileFormat={fileFormat} accept={accept} className={`hidden ${className}`} onChange={onChange} {...props} />
            </label>
        </div>
    );
}