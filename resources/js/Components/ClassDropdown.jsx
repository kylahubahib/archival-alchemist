...
const DeleteDocumentIcon = (props) => (
  ...
  >
    ...
    />
    <path
      d="M19.23 8.14c-.24-.25-.57-.39-.91-.39H5.68c-.34 0-.68.14-.91.39-.23.25-.36.59-.34.94l.62 10.26c.11 1.52.25 3.42 3.74 3.42h6.42c3.49 0 3.63-1.89 3.74-3.42l.62-10.25c.02-.36-.11-.7-.34-.95ZM13.29 19.1h-2.57c-.36 0-.66-.3-.66-.66v-3.25c0-.36.3-.66.66-.66h2.57c.36 0 .66.3.66.66v3.25c0 .36-.3.66-.66.66Zm1.95-5.62c-.26.25-.67.25-.94 0-.26-.25-.26-.67 0-.94.26-.26.67-.26.94 0 .26.26.26.68 0 .94Zm-2.85 1.42h-.01c-.36 0-.66-.3-.66-.66v-3.25c0-.36.3-.66.66-.66s.66.3.66.66v3.25c0 .36-.3.66-.66.66Z"
      fill="currentColor"
    />
  </svg>
);
  ...
  return (
    <Dropdown>
      ...
      <DropdownMenu aria-label="Class actions">
        <DropdownItem className={cn("flex items-center")}>
