...
export default function Edit({ isOpen, onClose, subscriptionPlans, planFeatures, features }) {
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        plan_term: subscriptionPlans.plan_term,
        plan_type: subscriptionPlans.plan_type,
        plan_user_num: subscriptionPlans.plan_user_num ? subscriptionPlans.plan_user_num : 0,
        plan_discount: subscriptionPlans.plan_discount ? subscriptionPlans.plan_discount : 0,
        free_trial_days: subscriptionPlans.free_trial_days ? subscriptionPlans.free_trial_days : 0,
        plan_status: subscriptionPlans.plan_status,
        plan_text: subscriptionPlans.plan_text,
        plan_features: [],
    });

    useEffect(() => {
        setData('plan_features', getFeaturesByPlanId(subscriptionPlans.id));
    }, [subscriptionPlans.id]);

    const submit = (e) => {
        e.preventDefault();
        put(route('manage-subscription-plans.update', subscriptionPlans.id), {
            ...data,
            preserveScroll: true,
            onSuccess: () => {
                onClose();
