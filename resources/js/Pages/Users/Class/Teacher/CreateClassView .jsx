...
const CreateClassView = ({ userId }) => {
    ...
    const [isViewClassOpen, setIsViewClassOpen] = useState(false); // New state to track ViewClass display
    ...
    return (
        <div className="flex flex-col items-start justify-start w-h-screen p-6 bg-gray-100">
             {isViewClassOpen ? (
                 <ViewClass onBack={handleBack} /> // Pass handleBack as a prop to ViewClass
            ) : (
                <>
                        ...
                        <Card key={index} isFooterBlurred radius="lg" className="border-none">
                            <div className="flex items-center p-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-black">{folder.section_name}</p>
                                </div>
                            </div>
