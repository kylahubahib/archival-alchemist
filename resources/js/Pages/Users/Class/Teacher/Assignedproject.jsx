...
const AssignedProject = ({ folders }) => {
    ...
    const MemoizedCard = React.memo(({ task }) => (
        ...
        >
            ...
            <div className="mt-4 text-center">
                <Button color="primary" className="w-full">View Details</Button>
            </div>
        </Card>
    ));
    ...
    return (
        <div className="p-5 bg-gray-100 rounded-lg shadow-lg w-full">
            ...
            <div className="relative w-full h-48 mb-5">
                ...
                />
                {/* Text Overlay: Believe in Yourself */}
    ...
    <h2 className="text-white text-xl font-bold">- Alan Palmer -</h2>
            ...
            {loading && !tasks.length && (
                <div className="flex flex-col items-center gap-5 py-3">
                    {/* Skeleton loading effect for task cards */}
                    {[...Array(5)].map((_, index) => (
                        <div
                            key={index}
                            className="w-[95%] max-w-4xl p-6 bg-gray-200 shadow-md rounded-lg animate-pulse"
                        >
