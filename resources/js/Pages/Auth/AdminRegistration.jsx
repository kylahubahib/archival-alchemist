...
export default function AdminRegistration({ tokenData }) {
    ...
    const handleRegisterSubmit = (e) => {
        ...
        post(route('admin.submit-admin-registration'), {
            onSuccess: () => {
                // reset();
                // clearErrors();
                alert('Success');
    ...
    return (
        <div className="bg-customLightBlue">
            <section>
                <form onSubmit={handleRegisterSubmit} className="container w-full flex flex-col max-w-[19rem] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl items-center justify-center min-h-screen px-6 mx-auto space-y-6">
