        ...
        <GuestLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Pricing</h2>}>
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-5 lg:px-6">
                ...
                <div className="flex flex-col space-x-5">
                    <div>
                        <div className="mb-5  text-3xl font-light text-gray-500 "> Personal Plans (Students and Teachers)</div>
                    ...
                    <div className="mt-8">
                        <div className="mb-5 text-3xl font-light text-gray-500"> Institutional Plans</div>
