...
const handleDeleteConfirmation = (postId) => {
  ...
  if (loading) return <div className="flex justify-center my-20"><Spinner/></div>; 
                ...
                posts.map(post => (
                    ...
                    >
                        ...
                        <div className="flex items-start space-x-4">
                            <img
                                src={`http://127.0.0.1:8000/${user?.user_pic || 'default-avatar.jpg'}`}
